...
public class HomePageTestStepDefinitions extends HomePageTest {
    ...
    public void user_types_in_search_box(String userSearchText){
        ...
        //wait for search auto complete results to appear
        //BaseTest.wait.until(ExpectedConditions.visibilityOfElementLocated((new By.ByClassName("sbqs_c"))));

    }

    @Then("^User should see (.*) printed on the search box$")
